...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Ingenuity server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Ingenuity server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ingenuity features */
        {"ingenuity", "masternode", &masternode, true, true, false},
        {"ingenuity", "listmasternodes", &listmasternodes, true, true, false},
        {"ingenuity", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ingenuity", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ingenuity", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ingenuity", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ingenuity", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ingenuity", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ingenuity", "masternodedebug", &masternodedebug, true, true, false},
        {"ingenuity", "startmasternode", &startmasternode, true, true, false},
        {"ingenuity", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ingenuity", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ingenuity", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ingenuity", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ingenuity", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ingenuity", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ingenuity", "mnbudget", &mnbudget, true, true, false},
        {"ingenuity", "preparebudget", &preparebudget, true, true, false},
        {"ingenuity", "submitbudget", &submitbudget, true, true, false},
        {"ingenuity", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ingenuity", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ingenuity", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ingenuity", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ingenuity", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ingenuity", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ingenuity", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ingenuity", "checkbudgets", &checkbudgets, true, true, false},
        {"ingenuity", "mnsync", &mnsync, true, true, false},
        {"ingenuity", "spork", &spork, true, true, false},
        {"ingenuity", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzingyseed", &getzingyseed, false, false, true},
        {"zerocoin", "setzingyseed", &setzingyseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzingy", &searchdzingy, false, false, true},
        {"zerocoin", "dzingystate", &dzingystate, false, false, true}
...
{
    return "> ingenuity-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3117/\n";
}
