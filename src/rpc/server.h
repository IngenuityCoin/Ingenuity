...
/**
 * Ingenuity RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzingyseed(const UniValue& params, bool fHelp);
extern UniValue getzingyseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzingy(const UniValue& params, bool fHelp);
extern UniValue dzingystate(const UniValue& params, bool fHelp);
