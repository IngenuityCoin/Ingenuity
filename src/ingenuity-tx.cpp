...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ingenuity ingenuity-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ingenuity-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ingenuity transaction") + "\n" +
                               "  ingenuity-tx [options] -create [commands]   " + _("Create hex-encoded ingenuity transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ingenuity transaction
