...
/** Utility functions used by the Ingenuity Qt UI.
 */
namespace GUIUtil
{
...
// Render Ingenuity addresses in monospace font
...
// Parse "ingenuity:" URI into recipient object, return true on successful parsing
