...
/* Ingenuity GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ingenuity"
#define QAPP_ORG_DOMAIN "ingenuity.org"
#define QAPP_APP_NAME_DEFAULT "Ingenuity-Qt"
#define QAPP_APP_NAME_TESTNET "Ingenuity-Qt-testnet"
