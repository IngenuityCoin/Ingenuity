...
public:
    ...
    void setZIngyControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzINGY_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzINGY_clicked();
    void on_pushButtonZIngyControl_clicked();
