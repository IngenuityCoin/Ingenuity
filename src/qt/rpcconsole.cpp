                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzINGYPathCustom = GetArg("-zingybackuppath", "");
    ...
    if(!strzINGYPathCustom.empty()) {
        ui->wallet_customzingybackuppath->setText(QString::fromStdString(strzINGYPathCustom));
        ui->wallet_customzingybackuppath_label->setVisible(true);
        ui->wallet_customzingybackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzINGYPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Ingenuity RPC console.") + "<br>" +
