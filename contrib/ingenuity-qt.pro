...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ingenuity-cli.cpp \
           src/ingenuity-tx.cpp \
           src/ingenuity.cpp \
           src/db.cpp \
           ...
           src/qt/ingenuity.cpp \
           src/qt/ingenuitystrings.cpp \
...
RESOURCES += src/qt/ingenuity.qrc src/qt/ingenuity_locale.qrc

TRANSLATIONS += src/qt/locale/ingenuity_bg.ts \
                src/qt/locale/ingenuity_de.ts \
                src/qt/locale/ingenuity_en.ts \
                src/qt/locale/ingenuity_es.ts \
                src/qt/locale/ingenuity_fi.ts \
                src/qt/locale/ingenuity_fr.ts \
                src/qt/locale/ingenuity_it.ts \
                src/qt/locale/ingenuity_ja.ts \
                src/qt/locale/ingenuity_pl.ts \
                src/qt/locale/ingenuity_pt.ts \
                src/qt/locale/ingenuity_ru.ts \
                src/qt/locale/ingenuity_sk.ts \
                src/qt/locale/ingenuity_sv.ts \
                src/qt/locale/ingenuity_vi.ts \
                src/qt/locale/ingenuity_zh_CN.ts \
                src/qt/locale/ingenuity_zh_TW.ts
