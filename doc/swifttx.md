...
This mechanism has been integrated into Bitcore-Node-Ingenuity which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Ingenuity-Project/insight-api-ingenuity#web-socket-api](https://github.com/Ingenuity-Project/insight-api-ingenuity#web-socket-api) 
* API: [https://github.com/Ingenuity-Project/insight-api-ingenuity#swifttx-transactions](https://github.com/Ingenuity-Project/insight-api-ingenuity#swifttx-transactions) 
...
By default, the Ingenuity daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ingenuity daemon:
