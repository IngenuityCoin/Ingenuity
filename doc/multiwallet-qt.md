...
In order to support loading of multiple wallets in ingenuity-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ingenuity.cpp.
...
Changes to ingenuity.cpp
----------------------
ingenuity.cpp is the entry point into ingenuity-qt, and as such, will require some minor modifications to provide hooks for
