...
#   c) node1 mines 32 blocks, so now node 0 has 60001ingy, node 1 has 4250ingy, node2 has none.
#   d) node0 sends 601 ingy to node2, in two transactions (301 ingy, then 300 ingy).
