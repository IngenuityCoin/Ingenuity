...
The Ingenuity project operates an open contributor model where anyone is
...
The following applies to code changes to the Ingenuity project, and is not to be
confused with overall Ingenuity Network Protocol consensus changes.

Whether a pull request is merged into Ingenuity rests with the project merge
...
Patches that change Ingenuity consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ingenuity consensus, it must have been
...
The project leader is the release manager for each Ingenuity release.
